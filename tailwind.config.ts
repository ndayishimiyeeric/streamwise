  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        "muted-gradient": "linear-gradient(125.17deg, #272727 0%, #11101d 100%)",
        blue__gradient: "linear-gradient(180deg, rgba(188, 165, 255, 0) 0%, #214d76 100%)",

        pink__gradient: "linear-gradient(90deg, #f4c4f3 0%, #fc67fa 100%)",

        white__gradient: "linear-gradient(to left, #232526, #414345)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
